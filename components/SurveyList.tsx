        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="p-6 bg-slate-50/50">
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <p className="text-slate-900 font-bold">{project.powerKwp} kWp</p>
                            </div>
                            <div>
                                <p className="text-xs text-slate-400 font-semibold uppercase">Data</p>
                                <p className="text-slate-900 font-bold">{new Date(project.startDate).toLocaleDateString()}</p>
                            </div>
                        </div>
            ...
            {projects.length === 0 && (
                <div className="col-span-full py-16 text-center text-slate-400 bg-white rounded-3xl border border-dashed border-slate-200">
                    ...
                    <h3 className="text-lg font-bold text-slate-600">Nenhuma vistoria pendente</h3>
